...
public class Main {
    ...
    public static double getExchange(String baseCurrency, String quoteCurrency, double amount) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(amount + " " + baseCurrency + " to " + df.format(getExchange(baseCurrency, quoteCurrency, amount)) + " " + quoteCurrency);
